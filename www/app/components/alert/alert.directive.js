...
fcSocialApp.directive('jhAlert', function(AlertService) {
        return {
            restrict: 'E',
        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('fcSocialServerApp.httpError', function (event, httpResponse) {
                        var i;
                            ...
                            case 400:
                                if (httpResponse.data && httpResponse.data.fieldErrors) {
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('fcSocialServerApp.' + fieldError.objectName + '.' + convertedField);
